...
import com.opurex.ortus.client.utils.file.*;
...
public abstract class AbstractDataTest {
    ...
    public void setup() throws IOException {
        ...
        file.getParentFile().mkdirs();
        file.createNewFile();
        mockStatic(OrtusPOS.class);
        expect(OrtusPOS.getAppContext()).andStubReturn(this.fakeContext);
    ...
    protected void replayContext() {
        ...
        PowerMock.replay(OrtusPOS.class);
    }
