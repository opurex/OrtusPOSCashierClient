...
public class PaymentModeValueBtnItem extends LinearLayout implements TextWatcher
{
    ...
    public PaymentModeValueBtnItem(Context context, PaymentMode.Value value, int count) {
        ...
        this.button = (MaterialButton) this.findViewById(R.id.value_button);
        this.input = (TextInputEditText) this.findViewById(R.id.count);
        ...
        this.input.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    t.input.clearFocus();
                    if (t.listener != null) {
                        t.listener.countUpdated(t.getValue().getValue(), t.getCount());
                    }
                    return true;
                }
                return false;
