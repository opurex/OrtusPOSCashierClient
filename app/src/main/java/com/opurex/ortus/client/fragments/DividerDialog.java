...
import com.opurex.ortus.client.models.Floor;
...
import com.opurex.ortus.client.utils.Tuple;
import com.opurex.ortus.client.widgets.TicketLineItem;
...
public class DividerDialog extends OpurexPopupFragment {
    ...
    public View onCreateFrameView(LayoutInflater inflater, FrameLayout frameContainer, Bundle savedInstanceState) {
        ...
        setTitle(OrtusPOS.getStringResource(R.string.menu_divider));
        setPositiveTitle(OrtusPOS.getStringResource(R.string.divider_button_positive));
        setNegativeTitle(OrtusPOS.getStringResource(R.string.divider_button_negative));
