...
import com.opurex.ortus.client.drivers.printer.BasePowaPOSCallback;
import com.opurex.ortus.client.drivers.printer.PowaPrinter;
import com.opurex.ortus.client.drivers.printer.documents.PrintableDocument;
import com.opurex.ortus.client.utils.IntegerHolder;
import com.opurex.ortus.client.utils.exception.ScannerNotFoundException;
        ...
        if (powa != null) {
            ...
            if (scanner != null && scanner.getSelectedScanner() == null) {
                ...
                try {
                    ...
                    scanner.setScannerAutoScan(OrtusPOS.getConf().scannerIsAutoScan());
