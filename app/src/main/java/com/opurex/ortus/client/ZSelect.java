...
import com.opurex.ortus.client.widgets.ZTicketAdapter;
...
public class ZSelect extends POSConnectedTrackedActivity
    ...
    private void askReprint() {
        ...
        dismissAlertDialog();
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(this);
        builder.setMessage(OrtusPOS.getStringResource(R.string.print_ask_retry));
    ...
    public void onDeviceManagerEvent(POSDeviceManager manager, DeviceManagerEvent event) {
        switch (event.what) {
            ...
            case DeviceManagerEvent.PrintDone:
                ...
                break;
            default:
                OrtusPOS.Log.d("Uncaught event n°" + event.what);
        }
    }
