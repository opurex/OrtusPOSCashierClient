...
import com.opurex.ortus.client.models.Cash;
import com.opurex.ortus.client.models.Receipt;
import com.opurex.ortus.client.models.ZTicket;
import com.opurex.ortus.client.utils.exception.NoArchiveException;
import com.opurex.ortus.client.utils.exception.SaveArchiveException;
import com.opurex.ortus.client.utils.exception.loadArchiveException;
import com.opurex.ortus.client.utils.file.File;
...
public class CashArchive {
    ...
    public static boolean archiveCurrent(ZTicket z)
            throws IOException {
        Context ctx = OrtusPOS.getAppContext();
        try {
    ...
    public static void clear(Context ctx) {
        java.io.File dir = OrtusPOS.getAppContext().getDir(ARCHIVESDIR, Context.MODE_PRIVATE);
    ...
    public static String getAFileArchive(int index) throws NoArchiveException {
        ...
        String[] file = OrtusPOS.getAppContext().getDir(ARCHIVESDIR, Context.MODE_PRIVATE).list();
