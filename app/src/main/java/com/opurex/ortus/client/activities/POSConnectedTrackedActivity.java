...
import com.opurex.ortus.client.drivers.DeviceService;
import com.opurex.ortus.client.drivers.POSDeviceManager;
import com.opurex.ortus.client.drivers.printer.documents.OCPM083TestDocument;
...
import com.opurex.ortus.client.drivers.printer.documents.TestDocument;
    ...
    implements DeviceManagerEventListener, Serializable
{
    ...
    public boolean printOCPPM083Test() {
        if (this.deviceService != null) {
            return this.deviceService.print(new OCPM083TestDocument());
        }
        return false;
    }
    
    public boolean printSampleTicket() {
        // This would create and print a sample ticket
        // For now, we'll use the existing test document
        if (this.deviceService != null) {
            return this.deviceService.print(new OCPM083TestDocument());
        }
        return false;
    ...
    public boolean printSampleReceipt() {
        // This would create and print a sample receipt
        // For now, we'll use the existing test document
        if (this.deviceService != null) {
            return this.deviceService.print(new OCPM083TestDocument());
        }
