...
import com.opurex.ortus.client.models.LocalTicket;
...
import com.opurex.ortus.client.sync.ServerLoader;
import com.opurex.ortus.client.activities.TrackedActivity;
import com.opurex.ortus.client.widgets.CustomerTicketHistoryAdapter;
...
public class CustomerInfoDialog extends DialogFragment
    ...
    /**
     * Uploads com.opurex.ortus.client to server
     * Called in sync mode
     *
    ...
    private class onItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            b.setMessage(OrtusPOS.getStringResource(R.string.ticket_ask_refund));
