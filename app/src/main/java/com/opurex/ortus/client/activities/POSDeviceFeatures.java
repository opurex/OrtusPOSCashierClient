    ...
    implements View.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Set device info
        ((TextView) this.findViewById(R.id.driver)).setText("Device driver: " + OrtusPOS.getConfiguration().getPrinterDriver());
        ((TextView) this.findViewById(R.id.model)).setText("Device model: " + OrtusPOS.getConfiguration().getPrinterModel());
        ((TextView) this.findViewById(R.id.address)).setText("Device address: " + OrtusPOS.getConfiguration().getPrinterAddress());
        // Set buttons
        ...
        this.findViewById(R.id.onOCPPM083PrinterClick).setOnClickListener(this);
        this.findViewById(R.id.onSampleTicketClick).setOnClickListener(this);
        this.findViewById(R.id.onSampleReceiptClick).setOnClickListener(this);
    ...
    public void onOCPPM083PrinterClick(View view) {
        inc(PRINT_NUMBER_PENDING);
        addLog(" - Printing OCPP M083 Test..");
        this.printOCPPM083Test();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.onPrinterClick:
                onPrinterClick(v);
                break;
            case R.id.onOCPPM083PrinterClick:
                onOCPPM083PrinterClick(v);
                break;
            case R.id.onSampleTicketClick:
                onSampleTicketClick(v);
                break;
            case R.id.onSampleReceiptClick:
                onSampleReceiptClick(v);
                break;
        }
    }
    
    public void onSampleTicketClick(View view) {
        inc(PRINT_NUMBER_PENDING);
        addLog(" - Printing Sample Ticket..");
        // For now, we'll use the OCPP M083 test document as a sample
        this.printSampleTicket();
    }
    
    public void onSampleReceiptClick(View view) {
        inc(PRINT_NUMBER_PENDING);
        addLog(" - Printing Sample Receipt..");
        // For now, we'll use the OCPP M083 test document as a sample
