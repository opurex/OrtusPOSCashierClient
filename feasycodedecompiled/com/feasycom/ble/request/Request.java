package com.feasycom.ble.request;
...
@Metadata(
   ...
   d2 = {"Lcom/feasycom/ble/request/Request;", "", "type", "Lcom/feasycom/common/bean/Type;", "(Lcom/feasycom/common/bean/Type;)V", "getType", "()Lcom/feasycom/common/bean/Type;", "component1", "copy", "equals", "", "other", "hashCode", "", "toString", "", "FeasyBlueLibrary_release"}
)
public final class Request {
   ...
   public boolean equals(@Nullable Object var1) {
      if (this == var1) {
         return true;
      } else if (!(var1 instanceof Request)) {
         return false;
      } else {
         Request var10000 = this;
         Request var2 = (Request)var1;
         return var10000.type == var2.type;
      }
   }
}
