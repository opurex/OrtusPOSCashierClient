...
public class SwitchButtons extends View {
     ...
     * 开启状态背景色
     */
    protected int mAccentColor = 0xFF169bd5;
    /**
     * 开启状态按钮描边色
     */
    ...
    public SwitchButtons(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwitchButtons(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        setLayerType(LAYER_TYPE_SOFTWARE, null);

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SwitchButtons);
        mChecked = array.getBoolean(R.styleable.SwitchButtons_android_checked, mChecked);
        setEnabled(array.getBoolean(R.styleable.SwitchButtons_android_enabled, isEnabled()));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (MeasureSpec.getMode(widthMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                widthMeasureSpec = MeasureSpec.makeMeasureSpec((int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 56, getResources().getDisplayMetrics()) + getPaddingLeft() + getPaddingRight()), MeasureSpec.EXACTLY);
                break;
        ...
        switch (MeasureSpec.getMode(heightMeasureSpec)) {
            case MeasureSpec.AT_MOST:
            case MeasureSpec.UNSPECIFIED:
                heightMeasureSpec = MeasureSpec.makeMeasureSpec((int) (MeasureSpec.getSize(widthMeasureSpec) * mAspectRatio) + getPaddingTop() + getPaddingBottom(), MeasureSpec.EXACTLY);
                break;
            case MeasureSpec.EXACTLY:
            default:
                break;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isCanVisibleDrawing) {
            ...
            mShadowGradient = new RadialGradient(bCenterX, bCenterY, mRadius, Color.argb(200, red, green, blue), Color.argb(25, red, green, blue), Shader.TileMode.CLAMP);
        }
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(SwitchButtons button, boolean isChecked);
    }
