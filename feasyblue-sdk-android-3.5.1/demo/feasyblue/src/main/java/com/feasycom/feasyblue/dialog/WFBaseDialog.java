...
import com.feasycom.feasyblue.action.AnimAction;
import com.feasycom.feasyblue.action.ClickAction;
import com.feasycom.feasyblue.action.ContextAction;
import com.feasycom.feasyblue.action.HandlerAction;
import java.lang.ref.SoftReference;
import java.util.ArrayList;
import java.util.List;

public class WFBaseDialog extends AppCompatDialog implements ContextAction, HandlerAction, ClickAction, DialogInterface.OnShowListener, DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {

    private final ListenersWrapper<WFBaseDialog> mListeners = new ListenersWrapper<>(this);
    ...
    public WFBaseDialog(Context context) {
        this(context, R.style.BaseDialogStyle);
    }

    public WFBaseDialog(Context context, int themeResId) {
    ...
    public static class Builder<B extends Builder> implements ContextAction, ClickAction {
         ...
         */
        protected WFBaseDialog createDialog(Context context, @StyleRes int themeId) {
            return new WFBaseDialog(context, themeId);
        }
    ...
    private static final class DialogLifecycle implements Application.ActivityLifecycleCallbacks, OnShowListener, OnDismissListener {
        ...
        private static void with(Activity activity, WFBaseDialog dialog) {
        ...
        private DialogLifecycle(Activity activity, WFBaseDialog dialog) {
            mActivity = activity;
        ...
        @Override
        public void onShow(WFBaseDialog dialog) {
            mDialog = dialog;
        ...
        @Override
        public void onDismiss(WFBaseDialog dialog) {
            mDialog = null;
            if (mActivity != null) {
                mActivity.getApplication().unregisterActivityLifecycleCallbacks(this);
            }
    ...
    private static final class ViewClickWrapper implements View.OnClickListener {
        ...
        private final WFBaseDialog mDialog;
        private final OnClickListener mListener;

        private ViewClickWrapper(WFBaseDialog dialog, OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class KeyListenerWrapper implements DialogInterface.OnKeyListener {
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof WFBaseDialog) {
                mListener.onKey((WFBaseDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(WFBaseDialog dialog, V view);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(WFBaseDialog dialog);
    }
    ...
    public interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        void onCancel(WFBaseDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(WFBaseDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(WFBaseDialog dialog, KeyEvent event);
    }
}
