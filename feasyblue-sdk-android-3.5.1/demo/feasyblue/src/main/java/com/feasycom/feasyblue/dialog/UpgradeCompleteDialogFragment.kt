...
import kotlinx.android.synthetic.main.upgrade_complete_dialog.*

class UpgradeCompleteDialogFragment: DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.upgrade_complete_dialog, null)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        agreeCompleteTextView.setOnClickListener {
            onAgree?.invoke()
        }
    ...
    companion object {
        const val TAG = "UpgradeCompleteDialogFragment"
    }
}