# Complete OrtusPOS Scale Integration Solution - Final
...
The ProductScaleDialog now has a sophisticated color-coded status system:
...
- **Red** (`holo_red_dark`): When scale is not connected and manual entry is disabled
  ...
  - Signals that user cannot proceed with weight entry
...
### 17. Benefits of Enhanced Virtual Scale Testing
...
### For Virtual Scale Testing (Requires Explicit Enable):
